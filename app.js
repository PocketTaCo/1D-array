...
function order(food, drink, dessert){
	...
	return "May i get " + food + " also I'll get a " + drink + " then after those delicious meal I'll order some " + dessert + " for dinner, please?"
}
...
function moreArrayMethods(priorities){
	...
	priorities.push("too much games")
	priorities.sort()
	//Return the changed array
	return priorities
}
